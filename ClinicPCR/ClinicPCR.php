<?php
$sql_ClinicPCR = "SELECT * FROM SARS_CoV_2_PCR WHERE Code = '" . $code . "'";
...
<div class="col-xl-12 order-xl-1">
    <div class="card">
        <div class="card-body">
            <form action="ClinicPCR/API/backend.php?api=<?php echo $sState; ?>" method="POST">
                <div class="pl-lg-4">
                    <div class="col-lg-12">
                        <div class="form-group" id="details">
                            <div class="form-check form-check-inline">
                                <h1 class="text-muted mb-4">ผลการตรวจ SARS-CoV-2 PCR</h1>
                            </div>
                            <div class="container">
                                    ...
                                    <table id="myTable" class="table order-list">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        <input type="number" name="no<?php echo $j; ?>" id="no<?php echo $j; ?>" placeholder="ครั้งที่" value="<?php echo $row_ClinicPCR["Order_PCR"]; ?>" class="form-control" readonly />
                                                    </td>
                                                    <td>
                                                        <input type="date" name="keep_date<?php echo $j; ?>" id="keep_date<?php echo $j; ?>" placeholder="วันที่เก็บ" value="<?php echo $row_ClinicPCR["Date_PCR"]; ?>" class="form-control" />
                                                    </td>
                                                    <td>
                                                        <select class="form-control" name="type<?php echo $j; ?>" id="type<?php echo $j; ?>">
                                                            <option value="<?php echo $row_ClinicPCR["Example_type_PCR"]; ?>"><?php echo $row_ClinicPCR["Example_type_PCR"]; ?></option>
                                                            <option value="NPS">NPS</option>
                                                            <option value="THROAT T(TH)">THROAT T(TH)</option>
                                                            <option value="IPS+PS">IPS+PS</option>
                                                        </select>
                                                    ...
                                                    <td>
                                                        <textarea type="text" name="station<?php echo $j; ?>" id="station<?php echo $j; ?>" placeholder="สถานที่ส่งตรวจ" class="form-control"><?php echo $row_ClinicPCR["Station_PCR"]; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <select class="form-control" name="detect<?php echo $j; ?>" id="detect<?php echo $j; ?>">
                                                            <option value="<?php echo $row_ClinicPCR["Detected_type"]; ?>"><?php echo $row_ClinicPCR["Detected_type"]; ?></option>
                                                            <option value="Detected">Detected</option>
                                                            <option value="Non-Detected">Non-Detected</option>
                                                            <option value="Income">Income</option>
                                                        </select>
...
<script>
    $(document).ready(function() {
        ...
        $("#addrow").on("click", function() {
            ...
            cols += '<td><div class="form-check form-check-inline"><select class="form-control" name="detect' + counter + '" id="detect' + counter + '"><option value = "<?php echo $row_ClinicPCR["Detected_type"]; ?>"><?php echo $row_ClinicPCR["Detected_type"]; ?></option><option value="Detected">Detected</option><option value="Non-Detected">Non-Detected</option><option value="Income">Income</option></select></div> </td>';
