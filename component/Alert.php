    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <?php if($_SESSION["change_user"] != ''){ ?>
                        เปลี่ยนชื่อผู้ใช้งานและรหัสผ่านเรียบร้อยแล้ว<br>
                        
                <?php }else{?>
                    หมายเลข Refer : <?php echo $_SESSION["refer"]; ?><br>
                    บันทึก <?php echo $_SESSION["subject_message"]; ?> เรียบร้อย
                    <?php } ?>
                </div>
...
<?php unset($_SESSION["alert_status"]);
